<?php
	...
	class Model {
		...
		*	Raw Query Selection
		*
		*	Uses raw SQL Code for super special calls that aren't good
		*		for standard built in functions
		*
		*	@access				public				[closed at the end of script]
		*	@return				void				[closes the db connection only]
		*
		*/
		...
		*
		*	Shuts down the connection to MySQL
		*
		*	@access				public				[closed at the end of script]
		*	@return				void				[closes the db connection only]
		*
